...
#[cfg(all(feature = "2d", feature = "bevy"))]
mod primitives2d;
#[cfg(all(feature = "3d", feature = "bevy"))]
mod primitives3d;
...
#[cfg_attr(feature = "bevy", reflect(PartialEq, Debug))]
...
#[cfg_attr(feature = "bevy", reflect(Hash, PartialEq, Debug))]
pub enum FillMode {
