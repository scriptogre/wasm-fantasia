...
#[cfg_attr(feature = "bevy", reflect(Component, Debug, PartialEq, Default))]
...
#[cfg_attr(feature = "bevy", derive(EntityEvent))]
#[cfg_attr(feature = "serialize", derive(serde::Serialize, serde::Deserialize))]
...
#[cfg_attr(feature = "bevy", reflect(Debug, Default, PartialEq))]
...
#[cfg_attr(feature = "bevy", reflect(no_field_bounds))]
#[non_exhaustive]
#[allow(missing_docs)]
