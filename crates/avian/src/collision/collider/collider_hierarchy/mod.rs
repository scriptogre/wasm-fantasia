...
#[cfg_attr(feature = "bevy", component(immutable, on_insert = <ColliderOf as Relationship>::on_insert, on_replace = <ColliderOf as Relationship>::on_replace))]
#[cfg_attr(feature = "bevy", require(ColliderTransform))]
...
#[cfg_attr(feature = "bevy", relationship_target(relationship = ColliderOf, linked_spawn))]
#[cfg_attr(feature = "serialize", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(
    all(feature = "bevy", feature = "serialize"),
    reflect(Serialize, Deserialize)
