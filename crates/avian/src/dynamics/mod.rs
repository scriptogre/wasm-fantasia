...
pub mod prelude {
    #[cfg(feature = "bevy")]
    pub use super::rigid_body::forces::{
        Forces, ReadRigidBodyForces, RigidBodyForces, WriteRigidBodyForces,
    };
    #[cfg(feature = "bevy")]
    pub(crate) use super::rigid_body::mass_properties::{ComputeMassProperties, MassProperties};
    #[cfg(all(feature = "bevy", feature = "xpbd_joints"))]
    ...
    #[expect(deprecated)]
    pub use super::{
        ccd::{SpeculativeMargin, SweepMode, SweptCcd},
        integrator::{CustomPositionIntegration, CustomVelocityIntegration, Gravity},
        joints::{
            ...
            JointFrame, LinearMotor, MotorModel, PrismaticJoint, RevoluteJoint,
        },
        rigid_body::{
            forces::{
                ConstantAngularAcceleration, ConstantForce, ConstantLinearAcceleration,
                ConstantLocalForce, ConstantLocalLinearAcceleration, ConstantTorque,
            },
            mass_properties::components::{
                AngularInertia, CenterOfMass, ColliderDensity, ComputedAngularInertia,
                ComputedCenterOfMass, ComputedMass, Mass, MassPropertiesBundle,
