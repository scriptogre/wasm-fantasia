...
use crate::prelude::*;
// AccumulatedLocalAcceleration is only referenced in `require(...)` which is bevy-only.
#[cfg(feature = "bevy")]
use crate::physics_transform::init_physics_transform;
#[cfg(feature = "bevy")]
use crate::prelude::forces::AccumulatedLocalAcceleration;
#[cfg(feature = "bevy")]
use bevy::{
...
#[cfg_attr(feature = "bevy", reflect(Debug, Component, Default, PartialEq))]
#[cfg_attr(feature = "bevy", require(
...
#[cfg_attr(feature = "bevy", component(immutable, on_add = RigidBody::on_add))]
pub enum RigidBody {
...
#[cfg_attr(feature = "bevy", reflect(Debug, Component, Default))]
...
#[derive(Clone, Copy, Debug, Default, Deref, DerefMut, PartialEq, From)]
#[cfg_attr(
    feature = "bevy",
    derive(bevy::prelude::Reflect, bevy::prelude::Component)
)]
...
/// }
/// ```
#[derive(Clone, Copy, Debug, Deref, DerefMut, PartialEq, From)]
#[cfg_attr(
    feature = "bevy",
    derive(bevy::prelude::Reflect, bevy::prelude::Component)
)]
...
#[cfg(feature = "2d")]
#[derive(Clone, Copy, Deref, DerefMut, Debug, Default, PartialEq, From)]
#[cfg_attr(
    feature = "bevy",
    derive(bevy::prelude::Reflect, bevy::prelude::Component)
)]
...
/// }
/// ```
#[derive(Debug, Clone, Copy, PartialEq, PartialOrd, Default, Deref, DerefMut, From)]
#[cfg_attr(
    feature = "bevy",
    derive(bevy::prelude::Component, bevy::prelude::Reflect)
)]
...
/// ```
#[rustfmt::skip]
#[derive(Debug, Clone, Copy, Default, Deref, DerefMut, From, PartialEq, PartialOrd, Eq, Ord)]
#[cfg_attr(feature = "bevy", derive(bevy::prelude::Component, bevy::prelude::Reflect))]
#[cfg_attr(feature = "serialize", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(all(feature = "bevy", feature = "serialize"), reflect(Serialize, Deserialize))]
#[cfg_attr(feature = "bevy", reflect(Debug, Component, Default, PartialEq))]
