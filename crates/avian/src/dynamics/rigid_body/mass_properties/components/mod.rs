...
// When bevy is off, Vec3/Quat/Mat3 are not available through bevy's prelude,
// so import them directly from glam for the f32-only 3d AngularInertia type.
#[cfg(feature = "3d")]
...
#[cfg_attr(feature = "bevy", reflect(Debug, Component, Default, PartialEq))]
#[cfg_attr(feature = "bevy", require(RecomputeMassProperties))]
#[cfg_attr(feature = "bevy", component(on_remove = on_remove_no_auto_mass_property))]
...
#[cfg_attr(feature = "bevy", component(storage = "SparseSet"))]
...
#[cfg_attr(feature = "bevy", derive(bevy::prelude::Bundle))]
#[cfg_attr(feature = "serialize", derive(serde::Serialize, serde::Deserialize))]
