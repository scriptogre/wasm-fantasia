...
#[cfg(not(feature = "bevy"))]
mod bevy_math_compat;
#[cfg(not(feature = "bevy"))]
pub use bevy_math_compat::{Dir2, Dir3, Isometry2d, Isometry3d, Ray2d, Ray3d, Rot2};
...
#[cfg(feature = "2d")]
pub(crate) type VectorF32 = Vec2;

/// The `f32` vector type chosen based on the dimension.
#[cfg(feature = "3d")]
pub(crate) type VectorF32 = Vec3;

/// The `i32` vector type chosen based on the dimension.
#[cfg(feature = "2d")]
pub(crate) type IVector = IVec2;

/// The `i32` vector type chosen based on the dimension.
#[cfg(feature = "3d")]
pub(crate) type IVector = IVec3;
...
pub(crate) fn pose_to_isometry(pose: &parry::math::Pose) -> bevy_math::Isometry2d {
    let rotation = bevy_math::Rot2::from_sin_cos(pose.rotation.im as f32, pose.rotation.re as f32);
    bevy_math::Isometry2d::new(pose.translation.f32(), rotation)
}
