...
fn on_hit_stop(
    ...
    // Crits still get half the speed reduction so they feel punchier without breaking flow
    ...
    // Use max, not sum — hitting 5 enemies should freeze the same as hitting 1
