...
#[sats(crate = __lib)]
pub(super) struct GroundPoundHitArgs {
    pub x: f32,
    pub y: f32,
    pub z: f32,
}

impl From<GroundPoundHitArgs> for super::Reducer {
    fn from(args: GroundPoundHitArgs) -> Self {
        Self::GroundPoundHit {
            x: args.x,
            y: args.y,
            z: args.z,
...
impl __sdk::InModule for GroundPoundHitArgs {
